 ...
 */
public class TaxBillPaymentActivity extends AppCompatActivity {
    AQuery aq;
    String[] items = new String[]{"URA", "NSSF", "KCCA", "Others"};
    ListView listView;
    ...
    private void listViewItemClick(int position){
        switch (position){
            case 0:
                startActivity(new Intent(this, URAPayment.class));
                break;
            case 1:
                startActivity(new Intent(this, NSSFPaymentActivity.class));
                break;
            case 2:
                startActivity(new Intent(this, KCCAPayment.class));
                break;
            case 3:
