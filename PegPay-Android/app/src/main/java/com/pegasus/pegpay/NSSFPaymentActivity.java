 ...
 */
public class NSSFPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nssf_payment_activity);
        aq = new AQuery(this);
    ...
    private void submit(){
        ...
        String tin = aq.id(R.id.txt_tin).getText().toString().trim();
        ...
        if(tin.isEmpty()){
            showErrorToast("Please enter your NSSF number");
            return;
        }
        if(amount.isEmpty()){
        ...
        params.put("recipient", "NSSF");
        params.put("ref", "NSSF Contribution " + customerRef);
    ...
    private void showConfirmation(String message){
        ...
        builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                alertDialog.dismiss();
                Intent i = new Intent(NSSFPaymentActivity.this, SelectPaymentMethodActivity.class);
