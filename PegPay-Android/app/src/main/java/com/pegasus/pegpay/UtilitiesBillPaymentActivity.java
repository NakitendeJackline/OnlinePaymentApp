 ...
 */
public class UtilitiesBillPaymentActivity extends AppCompatActivity {
    AQuery aq;
    String[] items = new String[]{"Umeme", "NWSC", "UEDCL", "Others"};
    ListView listView;
    ...
    private void listViewItemClick(int position){
        switch (position){
            case 0:
                startActivity(new Intent(this, UmemePaymentActivity.class));
                break;
            case 1:
                startActivity(new Intent(this, NWSCPaymentActivity.class));
                break;
            case 2:
                startActivity(new Intent(this, UEDCLPaymentActivity.class));
                break;
            case 3:
