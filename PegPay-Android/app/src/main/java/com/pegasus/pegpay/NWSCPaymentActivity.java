 ...
 */
public class NWSCPaymentActivity extends AppCompatActivity {
    ...
    private void submit(){
        ...
        params.put("recipient", "NWSC");
        params.put("ref", "Water Payment for " + meterNumber);
    ...
    private void showConfirmation(String message){
        ...
        builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                alertDialog.dismiss();
                Intent i = new Intent(NWSCPaymentActivity.this, SelectPaymentMethodActivity.class);
