 ...
 */
public class OtherPaymentsActivity extends AppCompatActivity {
    ...
    private void submit(){
        ...
        String merchantId = aq.id(R.id.txt_merchant_id).getText().toString().trim();
        ...
        if(merchantId.isEmpty()){
            showErrorToast("Please enter the merchant ID");
            return;
        }
        if(amount.isEmpty()){
        ...
        params.put("recipient", "Merchant");
        params.put("ref", "Merchant Payment " + customerRef);
    ...
    private void showConfirmation(String message){
        ...
        builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                alertDialog.dismiss();
                Intent i = new Intent(OtherPaymentsActivity.this, SelectPaymentMethodActivity.class);
