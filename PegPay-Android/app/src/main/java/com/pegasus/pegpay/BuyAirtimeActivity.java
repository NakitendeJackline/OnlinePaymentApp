...
public class BuyAirtimeActivity extends AppCompatActivity {
    ...
    private void submit(){
        ...
        params.put("recipient", "Airtime: " + phoneNumber);
        params.put("ref", "Airtime Payment for " + phoneNumber);
    ...
    private void showConfirmation(String message){
        ...
        builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                alertDialog.dismiss();
                Intent i = new Intent(BuyAirtimeActivity.this, SelectPaymentMethodActivity.class);
