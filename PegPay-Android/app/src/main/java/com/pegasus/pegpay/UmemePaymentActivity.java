 ...
 */
public class UmemePaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.umeme_bill_payment);
        aq = new AQuery(this);
    ...
    private void submit(){
        ...
        if(meterNumber.isEmpty()){
            showErrorToast("Please enter your meter number");
            return;
        }
        if(amount.isEmpty()){
        ...
        params.put("recipient", "UMEME");
        params.put("ref", "Bill Payment for " + meterNumber);
    ...
    private void showConfirmation(String message){
        ...
        builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                alertDialog.dismiss();
                Intent i = new Intent(UmemePaymentActivity.this, SelectPaymentMethodActivity.class);
