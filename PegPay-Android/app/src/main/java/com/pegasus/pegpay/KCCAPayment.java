 ...
 */
public class KCCAPayment extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kcca_payment_activity);
        aq = new AQuery(this);
    ...
    private void submit(){
        ...
        if(tin.isEmpty()){
            showErrorToast("Please enter your KCCA TIN");
            return;
        }
        if(amount.isEmpty()){
        ...
        params.put("recipient", "KCCA");
        params.put("ref", "KCCA Remittance " + customerRef);
    ...
    private void showConfirmation(String message){
        ...
        builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                alertDialog.dismiss();
                Intent i = new Intent(KCCAPayment.this, SelectPaymentMethodActivity.class);
