 ...
 */
public class URAPayment extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ura_payment);
        aq = new AQuery(this);
    ...
    private void submit(){
        ...
        if(tin.isEmpty()){
            showErrorToast("Please enter your TIN");
            return;
        }
        if(amount.isEmpty()){
        ...
        params.put("recipient", "URA");
        params.put("ref", "URA Payment " + customerRef);
    ...
    private void showConfirmation(String message){
        ...
        builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                alertDialog.dismiss();
                Intent i = new Intent(URAPayment.this, SelectPaymentMethodActivity.class);
